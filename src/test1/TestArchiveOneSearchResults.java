...
import static SupervisorAPI.ArchiveSearchOne.l1;
...
public class TestArchiveOneSearchResults
 {

  //CompareDSearch chps = new ArchiveSearchTwo();
  //   ArchiveSearchTwo chps = new ArchiveSearchTwo();
     ArchiveSearchOne chps = new ArchiveSearchOne();
     InsertGroupValues igv = new InsertGroupValues();
     ReadProperties rp = new ReadProperties();
     static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(TestArchiveOneSearchResults.class.getName());
...
public void bsuite() throws Exception
  {
       ...
       {
           System.out.println("Some problem in ArchiveSearch putCurrentDate");
      ...
      try
       {
        ...
        igv.updateValues("jdbc:sqlserver:"+rp.getProperty("Database_Location"), rp.getProperty("databaseName"),rp.getProperty("DB_username"), rp.getProperty("DB_pwd"),rp.getProperty("Archive_SearchDB_Location"),input_group_value);
       }
      
       catch (Exception e)
       {
           System.out.println("Some problem in ArchieveOneSearch InsertGroupValues");
           System.out.println(e.getMessage());
           log.info(e.getMessage());
       }     
  }
  ...
  @BeforeTest
   public void logintoSupervisor()
   {
      ...
      l1 = new Login();
        try {
            l1.login(rp.getProperty("LoginRequest"), rp.getProperty("archieveone_search_username"), rp.getProperty("archieveone_search_password"));
    ...
    public void testArchiveOneSearchResults(String parm1, Object parm2) throws Exception {
        System.out.println("Inside the testArchiveSearchOne method");
