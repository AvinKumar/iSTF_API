...
import static SupervisorAPI.AllProcessSearch.l1;
import Database.ChangeArchiveStartDate;
import Database.opensearchkwysConnection;
import SupervisorAPI.InsertGroupValues;
...
public class TestAllProcessResults
 {

  //CompareDSearch chps = new ArchiveSearchTwo();
  AllProcessSearch chps = new AllProcessSearch();
  InsertGroupValues igv = new InsertGroupValues();
  ReadProperties rp = new ReadProperties();
  static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(TestAllProcessResults.class.getName());
  ...
  public void bsuite() throws Exception
  {
       ...
       {
           System.out.println("Some problem in AllProcessSearch putCurrentDate");
      ...
      try
       {
        ...
        igv.updateValues("jdbc:sqlserver:"+rp.getProperty("Database_Location"), rp.getProperty("databaseName"), rp.getProperty("DB_username"), rp.getProperty("DB_pwd"),rp.getProperty("AllProcess_SearchDB_Location"),input_group_value);
       }
      
       catch (Exception e)
       {
           System.out.println("Some problem in AllProcessSearch InsertGroupValues");
           System.out.println(e.getMessage());
           log.info(e.getMessage());
       }  
  }
  ...
  @BeforeTest
   public void logintoSupervisor()
   {
      ...
      l1 = new Login();
            try
            {
                l1.login(rp.getProperty("LoginRequest"), rp.getProperty("allprocess_search_username"), rp.getProperty("allprocess_search_password"));
    ...
    public void testAllProcessSearchResults(String parm1, Object parm2) throws Exception {
        System.out.println("Inside the TestAllProcessSearch method");
