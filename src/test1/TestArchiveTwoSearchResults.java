...
import static SupervisorAPI.ArchiveSearchTwo.l1;
...
public class TestArchiveTwoSearchResults
 {

  //CompareDSearch chps = new ArchiveSearchTwo();
     ArchiveSearchTwo chps = new ArchiveSearchTwo();
    InsertGroupValues igv = new InsertGroupValues();
     ReadProperties rp = new ReadProperties();
     static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(TestArchiveTwoSearchResults.class.getName());
  ...
  public void bsuite() throws Exception
  {
       ...
       try
       {
		...
		chps.putArchiveSearchStartDate();
		System.out.println("Put Archieve Two Start Date method got executed");
       }
       catch (Exception e)
       {
           System.out.println("Some problem in ArchiveSearchTwo putCurrentDate/Archieve start date");
       ...
       try
       {
        ...
        input_group_value[12]=rp.getProperty("SUPMSGIDMSG");
            ...
            igv.updateValues("jdbc:sqlserver:"+rp.getProperty("Database_Location"),rp.getProperty("databaseName"), rp.getProperty("DB_username"), rp.getProperty("DB_pwd"),rp.getProperty("Archive_IdolSearchDB_Location"),input_group_value);
       }
      
       catch (Exception e)
       {
           System.out.println("Some problem in ArchieveSearchTwo InsertGroupValues");
           System.out.println(e.getMessage());
           log.info(e.getMessage());
       }  
  }
  ...
  @BeforeTest
   public void logintoSupervisor()
   {
      ...
      l1 = new Login();
        try {
            l1.login(rp.getProperty("LoginRequest"), rp.getProperty("archievetwo_search_username"), rp.getProperty("archivetwo_search_password"));
    ...
    public void testArchiveSearchTwoSearchResults(String parm1, Object parm2) throws Exception {
        System.out.println("Inside the testArchiveSearchTwo method");
